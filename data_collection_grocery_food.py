...
grocery_food_filter_products_bio = datacleaned_DF.rdd.filter(lambda r: (r[6] != None) &  (r[3] != None)) \
...
DF_filter_products_bio = spark.createDataFrame(grocery_food_filter_products_bio)
...
review_product_join.write.mode('overwrite').parquet("Grocery_and_Gourmet_Food.parquet")
